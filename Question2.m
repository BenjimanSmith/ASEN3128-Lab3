...
sgtitle('Deviation by +5^{\circ} in bank, Nonlinear');
 subplot(4,2,1);
plot(t1, X(:,7));
...
figure()
sgtitle('Deviation by +5^{\circ} in elevation, Nonlinear'); subplot(4,2,1);
plot(t1, X(:,7));
...
figure()
sgtitle('Deviation by +5^{\circ} in azimuth, Nonlinear'); subplot(4,2,1);
plot(t1, X(:,7));
...
figure()
sgtitle('Deviation by +0.1 rad/sec in roll rate');
 subplot(4,2,1);
plot(t1, X(:,7));
...
figure ()
sgtitle('Deviation by +0.1 rad/sec in pitch rate');
 subplot(4,2,1);
plot(t1, X(:,7));
...
figure()
sgtitle('Deviation by +0.1 rad/sec in yaw rate ');
 subplot(4,2,1);
plot(t1, X(:,7));
